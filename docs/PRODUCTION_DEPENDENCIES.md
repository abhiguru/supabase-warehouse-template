...
| 9 | Realtime application acceptance | CLOSED for source-demo orders/cart: physical iPhone15/iOS26.6.2 passed the complete live-update matrix on2026-09-23 at mobile `c943de56b460852e8bca71fbe481b40d0c5265e6` / backend `8c682e4d4b83d4f4a8cb2dc252a00702478b11f9`. Reviewed mobile PR#26/backend PR#40 and exact-main CI passed. Backend Realtime delivery/isolation/token/reconnect probe also passed after local Docker recovery. See mobile `docs/NATIVE_ACCEPTANCE.md` and [READINESS.md](READINESS.md). | Orders/cart only, with refresh after reconnect. Historical Android emulator acceptance was not rerun on the Mac. Target-scale resilience remains dependent on item8; stock/invoice subscriptions are outside scope. Production operator choices and item1 security findings remain open. |
